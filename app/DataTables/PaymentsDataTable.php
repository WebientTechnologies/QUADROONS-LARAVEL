...
class PaymentsDataTable extends BaseDataTable
{
    ...
    public function query()
    {
        ...
        $model = Payment::with(['invoice.client', 'order.client', 'currency:id,currency_symbol,currency_code'])
            ...
            ->select('payments.id', 'payments.company_id', 'payments.project_id', 'payments.currency_id', 'payments.invoice_id', 'payments.amount', 'payments.status', 'payments.paid_on', 'payments.remarks', 'payments.bill', 'payments.added_by', 'payments.order_id', 'payments.gateway', 'payments.transaction_id', 'payments.customer', 'payments.sender', 'payments.total_amount');
    ...
    protected function getColumns()
    {
        return [
            ...
            __('app.customer') => ['data' => 'customer', 'name' => 'customer', 'title' => __('Customer')],
            __('app.client_email') => ['data' => 'client_email', 'name' => 'client_email', 'visible' => false, 'title' => __('app.client_email')],
            __('app.sender') => ['data' => 'sender', 'name' => 'sender', 'title' => __('Sender')],
            ...
            __('app.total_amount') => ['data' => 'total_amount', 'name' => 'total_amount', 'title' => __('Total Amount')],
