...
<body>
    <div id="page">
        ...
        <div class = "layout-wrapper">
            <div>
                <div class="main-banner"><img src="/img/redbanner.jpg" width="100%" height="100%"> 
                    <div class="search-bar">
                    <div class="search-bar-box">
                        <div class="search-bar_wrapper"><input type="search" placeholder="Search for help..." required="required" class="input search-bar_input">
                        </div> </div></div> 
                </div>
                <div class="about-page-content-section">
                    ...
                    <div class="faq-section">
                        ...
                        <ul class="faq-list">
                            @foreach($faqs as $faq)
                                <li>
                                    <a href="#" class="faq-question" data-target="{{ $faq->id }}">
                                        {{ $faq->question }}
                                    </a>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        faqQuestions.forEach(question => {
            question.addEventListener('click', function (event) {
                ...
                const faqId = question.getAttribute('data-target');
                const faqAnswer = document.getElementById(`faq-answer-${faqId}`);
