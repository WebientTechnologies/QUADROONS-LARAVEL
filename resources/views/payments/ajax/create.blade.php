        ...
        <x-form id="save-payment-data-form">
            ...
            <div class="add-client bg-white rounded">
                ...
                <div class="row p-20">
                    ...
                    <div class="col-md-3">
                        <x-forms.text fieldId="customer" :fieldLabel="__('Customer')" fieldName="customer"
                             :fieldPlaceholder="__('customer')"
                            />
                    </div>
                ...
                <div class="row pl-20 pr-20">
                    ...
                    <div class="col-md-3">
                        <x-forms.text fieldId="total_amount" :fieldLabel="__('Total Amount')"
                        fieldName="total_amount"  fieldReadOnly="true"/>
                    </div>
                    ...
                    <div class="col-md-3">
                        <x-forms.text fieldId="sender" :fieldLabel="__('Sender')" fieldName="sender"
                             :fieldPlaceholder="__('sender')"
                            />
                    </div>
        ...
        $('#currency').change(function() {
            ...
            $.easyAjax({
                ...
                success: function(response) {
                    ...
                    var amount = parseFloat($('#amount').val()) || 0;
                    var exchangeRate = parseFloat(response.exchangeRate);
                    var totalAmount = amount / exchangeRate;
                    $('#total_amount').val(totalAmount.toFixed(2));
                }
            });
